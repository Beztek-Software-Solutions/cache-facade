...
{
    /// <summary>
    /// Configuration for a Dragonfly-backed cache. Dragonfly speaks the Redis protocol,
    /// so this reuses the Redis provider and RedLock via the same connection settings.
    /// </summary>
    public class DragonflyProviderConfiguration : RedisProviderConfiguration
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DragonflyProviderConfiguration"/> class.
        /// </summary>
        /// <param name="endpoint">Dragonfly server host:port.</param>
        ...
        public DragonflyProviderConfiguration(
            string endpoint,
            string password,
            string cacheName,
            bool useSSL = false,
        ...
        {
            this.ProviderType = CacheProviderType.Dragonfly;
        }
    }
}
